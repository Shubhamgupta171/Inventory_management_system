...
_SAMPLE_PRODUCTS = [
    {"name": "Wireless Mouse", "sku": "WM-001", "price": Decimal("24.99"), "stock_quantity": 120, "description": "Ergonomic 2.4GHz wireless mouse."},
    {"name": "Mechanical Keyboard", "sku": "KB-100", "price": Decimal("89.50"), "stock_quantity": 45, "description": "Hot-swappable RGB mechanical keyboard."},
    {"name": "USB-C Hub", "sku": "HUB-7P", "price": Decimal("39.00"), "stock_quantity": 8, "description": "7-in-1 USB-C multiport adapter."},
    {"name": "1080p Webcam", "sku": "CAM-1080", "price": Decimal("54.00"), "stock_quantity": 30, "description": "Full-HD webcam with privacy shutter."},
    {"name": "Noise-Cancelling Headphones", "sku": "HP-NC9", "price": Decimal("199.99"), "stock_quantity": 5, "description": "Over-ear ANC headphones, 30h battery."},
    {"name": "27\" 4K Monitor", "sku": "MON-27K", "price": Decimal("329.00"), "stock_quantity": 16, "description": "27-inch 4K UHD IPS display."},
    {"name": "Laptop Stand", "sku": "LS-ALU", "price": Decimal("32.50"), "stock_quantity": 60, "description": "Aluminium adjustable laptop stand."},
    {"name": "Portable SSD 1TB", "sku": "SSD-1TB", "price": Decimal("109.00"), "stock_quantity": 3, "description": "1TB USB-C portable solid-state drive."},
]
